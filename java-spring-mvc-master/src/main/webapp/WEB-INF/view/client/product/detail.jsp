                      ...
                      <nav>
                        <div class="nav nav-tabs mb-3">
                          ...
                          <button class="nav-link border-white border-bottom-0" type="button" role="tab"
                            ...
                            aria-controls="nav-comment" aria-selected="false">Đánh giá của bạn về sản phẩm</button>
                        </div>
                      </nav>
                        ...
                        <div class="tab-pane" id="nav-comment" role="tabpanel" aria-labelledby="nav-comment-tab">
                          <form:form action="/cmt/finish" method="post" modelAttribute="newFeed">
                            <div class="input-group">
                              <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                              <form:textarea class="form-control" path="content" rows="4"
                                placeholder="Nhập đánh giá của bạn..." aria-label="Đánh giá sản phẩm" />
